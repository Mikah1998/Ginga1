...
monogatari.configuration ('credits', {
    "Developers": {
        "Coding, UI": "<a href='https://x.com/AmanitaJT' style='color:rgb(255, 154, 59); text-decoration: underline;'>Amanita</a>",
    },

	"Translation and Ripping":{
		"Translation + Portrait & Background Rips": "<a href='https://www.youtube.com/channel/UCgKTdJsNcBnZAwSBEWIaDCw' style='color:rgb(255, 154, 59); text-decoration: underline;'>Mao</a>",
		"Translation": "Azure",
		"Tweaks to Script": "<a href='https://x.com/AmanitaJT' style='color:rgb(255, 154, 59); text-decoration: underline;'>Amanita</a>",
		"Map 2 Audio Rip": "<a href='https://x.com/Darkbeautylight' style='color:rgb(255, 154, 59); text-decoration: underline;'>Dark</a>"
	},

	"Sound Effects & Music": {
		"Gingira Ginga (Instrumental)": "Strawberry Prince",
		"Prop Plane Crash Sound Effect": "ZapSplat Sound Effects",
		"Body Fall Sound Effect": "Celestial SFX",
		"Walking on Sand Sound Effect": "Krotos",
		"Stronger Water Flow": "BoostSound"
	},
